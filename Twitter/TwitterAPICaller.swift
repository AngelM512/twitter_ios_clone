...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "OgSrkbA1yiTHxMXfc02xAqQpZ", consumerSecret: "b95BjuXZfiZutiZnh6KHLkCRRIWymwT2upca7sUrlbTsU0bGQu")
    var loginSuccess: (() -> ())?
